...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/user/login","method":"post","propertyName":"token"},"logout":{"url":"/user/logout","method":"post"},"user":{"url":"/user/auth","method":"get","propertyName":"user"}},"_name":"local"}))
